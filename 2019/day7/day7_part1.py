...
def run_program(instructions, phase1, phase2):
    global input_values
    input_values = [phase1, phase2]
    with mock.patch.object(builtins, 'input', mock_input):
        with mock.patch.object(builtins, 'print', mock_output):
...
def run_amplifiers(code, i1, i2, i3, i4, i5):
    o1 = run_program(code, i1, 0)
    o2 = run_program(code, i2, o1)
    o3 = run_program(code, i3, o2)
    o4 = run_program(code, i4, o3)
    o5 = run_program(code, i5, o4)
    return o5
